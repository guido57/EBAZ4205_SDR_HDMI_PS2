...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "C_M_AXIS_I_TDATA_ACTUAL_WIDTH" -parent ${Page_0}
  ipgui::add_param $IPINST -name "C_M_AXIS_I_TDATA_WIDTH" -parent ${Page_0}
  ipgui::add_param $IPINST -name "C_M_AXIS_Q_TDATA_ACTUAL_WIDTH" -parent ${Page_0}
  ipgui::add_param $IPINST -name "C_M_AXIS_Q_TDATA_WIDTH" -parent ${Page_0}
  ipgui::add_param $IPINST -name "C_S_AXIS_LO_TDATA_ACTUAL_WIDTH" -parent ${Page_0}
  ipgui::add_param $IPINST -name "C_S_AXIS_LO_TDATA_WIDTH" -parent ${Page_0}
  ipgui::add_param $IPINST -name "C_S_AXIS_RF_TDATA_ACTUAL_WIDTH" -parent ${Page_0}
  ipgui::add_param $IPINST -name "C_S_AXIS_RF_TDATA_WIDTH" -parent ${Page_0}
