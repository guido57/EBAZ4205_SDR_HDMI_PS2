...
HD_PWD='D:/Vivado_projects/EBAZ4205_clock_gen_eth_acq/EBAZ4205_clock_gen_eth_acq.runs/ebaz4205_axi_gpio_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ebaz4205_axi_gpio_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ebaz4205_axi_gpio_0_0.tcl
