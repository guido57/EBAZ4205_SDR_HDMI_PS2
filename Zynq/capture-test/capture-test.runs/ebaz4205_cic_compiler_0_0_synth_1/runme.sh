...
HD_PWD='D:/EBAZ4205_SDR/Zynq/capture-test/capture-test.runs/ebaz4205_cic_compiler_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ebaz4205_cic_compiler_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ebaz4205_cic_compiler_0_0.tcl
