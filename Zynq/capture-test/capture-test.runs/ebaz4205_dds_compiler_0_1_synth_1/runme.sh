...
HD_PWD='D:/EBAZ4205_SDR/Zynq/capture-test/capture-test.runs/ebaz4205_dds_compiler_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ebaz4205_dds_compiler_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ebaz4205_dds_compiler_0_1.tcl
