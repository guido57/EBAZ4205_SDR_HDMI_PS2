...
HD_PWD='/media/guido/Acer/EBAZ4205_SDR_HDMI_PS2/Vivado/Vivado.runs/ebaz4205_mult_gen_0_3_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ebaz4205_mult_gen_0_3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ebaz4205_mult_gen_0_3.tcl
