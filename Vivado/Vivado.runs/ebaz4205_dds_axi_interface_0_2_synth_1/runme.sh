...
HD_PWD='/media/guido/Acer/EBAZ4205_SDR_HDMI_PS2/Vivado/Vivado.runs/ebaz4205_dds_axi_interface_0_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ebaz4205_dds_axi_interface_0_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ebaz4205_dds_axi_interface_0_2.tcl
