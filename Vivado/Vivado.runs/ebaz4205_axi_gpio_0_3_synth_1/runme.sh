...
HD_PWD='/mnt/EEFAF48CFAF45277/EBAZ4205_SDR_HDMI_PS2/Vivado/Vivado.runs/ebaz4205_axi_gpio_0_3_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ebaz4205_axi_gpio_0_3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ebaz4205_axi_gpio_0_3.tcl
